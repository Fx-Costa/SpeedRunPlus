...
public class SpeedRunPlus extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(getCommand(SRPCommand.SRP)).setExecutor(new CommandHandler(gameManager));
    ...
    private void loadDependencies() {
        ...
        Plugin mvNether = Bukkit.getPluginManager().getPlugin("Multiverse-NetherPortals");
